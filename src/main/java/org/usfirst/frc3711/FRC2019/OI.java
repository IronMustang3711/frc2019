...
public class OI {
    ...
    public OI() {
        ...
        elevator = new JoystickButton(joystick1,7);
        arm = new JoystickButton(joystick1,8);
        wrist = new JoystickButton(joystick1,9);
        intake = new JoystickButton(joystick1,10);
        ...
        intake.whileHeld(new ManualLinkageControl(Robot.intake));
