...
public class CommandThing extends Command {
  ...
  @Override
  public boolean run() {
    return super.run() && !childrenFinished();
  }
  ...
  public boolean isFinished() {
    return isTimedOut() || isCanceled() || childrenFinished();
  }
  ...
  public void cancel() {
    super.cancel();
    children.forEach(Command::cancel);
  }
  ...
  public boolean isInterruptible() {
    assert children == null || super.isInterruptible() == children.stream().allMatch(Command::isInterruptible)
        : "heterogeneous interruptable status";
